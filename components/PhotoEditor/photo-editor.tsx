  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className="flex md:flex-row flex-col w-full gap-4 justify-center items-center">
        ...
        <div className="flex-1 flex flex-col justify-center items-center p-4 bg-gray-500 rounded-lg dark:bg-gray-800 max-w-md">
          {(() => {
            ...
            return (
              activeFormat && (
                <div className="flex flex-col w-full px-4 gap-1 items-end mb-2 font-semibold text-xs italic text-white">
